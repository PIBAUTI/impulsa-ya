      ...
      <div className="mx-auto max-w-4xl px-4 text-center">
        ...
        <div className="mt-8 grid grid-cols-4 gap-2 sm:gap-4">
          {cells.map((c) => (
            <div
              key={c.l}
              className="rounded-xl bg-white/5 border border-white/10 py-5 sm:py-7"
            >
    ...
    <div className="bg-white text-ink font-sans">
      ...
      <header className="sticky top-0 z-50 bg-white border-b border-border">
        <div className="mx-auto max-w-6xl px-4 h-16 flex items-center justify-between gap-3">
          ...
          <WaButton>
            <span className="hidden xs:inline sm:inline">Inscríbete por WhatsApp</span>
            <span className="inline xs:hidden sm:hidden">Inscríbete</span>
          </WaButton>
        </div>
      </header>
          ...
          <div className="mx-auto max-w-4xl px-4">
            ...
            <div className="mt-6 rounded-2xl border border-border bg-white p-6 sm:p-8 text-center shadow-sm">
              ...
              <div className="mt-4 flex items-baseline justify-center gap-3">
                <span className="text-ink/50 text-2xl line-through">$20</span>
